...
//  Input::PYTHIA8 = true;
 ...
 //   INPUTGENERATOR::SimpleEventGenerator[0]->add_particles(-211, 2);	
    ...
    INPUTGENERATOR::SimpleEventGenerator[0]->set_pt_range(1,5);
//    INPUTGENERATOR::SimpleEventGenerator[0]->set_eta_range(0.5, 0.5);
//    INPUTGENERATOR::SimpleEventGenerator[0]->set_phi_range(1.0, 1.0);
  //  INPUTGENERATOR::SimpleEventGenerator[0]->set_pt_range(2.0, 2.0);
 //   INPUTGENERATOR::SimpleEventGenerator[0]->set_p_range(0.0,0.0);
 //   INPUTGENERATOR::SimpleEventGenerator[0]->set_phi_range(1.0, 1.0);
 //   INPUTGENERATOR::SimpleEventGenerator[0]->set_eta_range(0.5, 0.5);
  }
  // Upsilons
